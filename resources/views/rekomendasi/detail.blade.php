                                    ...
                                    <div class="tab-content">
                                        <div id="tabs-text-1" class="tab-pane fade show active">
                                            ...
                                            <div class="form-group">
                                                ...
                                                <input type="text" name="id_perusahaan" class="form-control" value="{{$row->id_perusahaan}}" disabled>
                                            </div>
                                            <div class="form-group">
                                            ...
                                            <div class="form-group">
                                                <label>Website</label>
                                                <input type="text" name="website" class="form-control" value="{{$row->website}}"  disabled>
                                            </div>
                                            <div class="form-group">
                                                <label>Instagram</label>
                                                <input type="text" name="instagram" class="form-control" value="{{$row->instagram}}"  disabled>
                                            </div>
                                            <div class="form-group">
                                                <label>Facebook</label>
                                                <input type="text" name="facebook" class="form-control" value="{{$row->facebook}}"  disabled>
                                            </div>
                                        ...
                                        <div id="tabs-text-2" class="tab-pane fade">
                                            <div class="form-group">
                                                ...
                                                <input type="number" name="bor" class="form-control" value="{{$row->bor}}"  disabled>
                                            </div>
                                            <div class="form-group">
                                                <label>Kemampuan Kedalaman Mesin Bor (M)</label>
                                                <input type="number" name="kedalaman" class="form-control" value="{{$row->kedalaman}}"  disabled>
                                            </div>
                                            <div class="form-group">
                                                <label>Geolistrik</label>
                                                <select class="form-control" id="geolistrik" name="geolistrik"  disabled>
                                            ...
                                            <div class="form-group">
                                                ...
                                                <select class="form-control" id="kamera" name="kamera"  disabled>
                                        ...
                                        <div id="tabs-text-3" class="tab-pane fade">
                                            <div class="form-group">
                                                <label>Kontak</label>
                                                <input type="text" name="kontak" class="form-control" value="{{$row->kontak}}"  disabled>
                                            </div>
                                            <div class="form-group">
                                                <label>Layanan 24 Jam</label>
                                                <select class="form-control" id="layanan" name="layanan" disabled>
                                        ...
                                        <div id="tabs-text-4" class="tab-pane fade">
                                            <div class="form-group">
                                                ...
                                                <input type="number" name="air_tinggi" class="form-control" value="{{$row->air_tinggi}}"  disabled>
                                            </div>
                                            <div class="form-group">
                                                <label>Lokasi Debit Air Rendah</label>
                                                <input type="number" name="air_rendah" class="form-control" value="{{$row->air_rendah}}"  disabled>
                                            </div>
                                        </div>
                                        <div id="tabs-text-5" class="tab-pane fade">
                                             <div class="form-group">
                                                <label>Lama Perusahaan Berdiri</label>
                                                <input type="text" name="lama" class="form-control" value="{{$row->lama}}"  disabled>
                                            </div>
                                            <div class="form-group">
                                                <label>Jenis Perusahaan</label>
                                                <input type="text" name="jenis" class="form-control" value="{{$row->jenis}}"  disabled>
                                            </div>
                                        </div>
                                        <div id="tabs-text-6" class="tab-pane fade">
                                            <div class="form-group">
                                                <label>Durasi Penyusunan Alat Konstruksi (Hari)</label>
                                                <input type="text" name="hari" class="form-control" value="{{$row->hari}}"  disabled>
                                            </div>
                                        </div>
                                        <div id="tabs-text-7" class="tab-pane fade">
                                            <div class="form-group">
                                                <label>Layanan Informasi Yang Diberikan</label>
                                                <select class="form-control" id="layanan_informasi" name="layanan_informasi" disabled>
                                            ...
                                            <div class="form-group">
                                                ...
                                                <select class="form-control" id="sipa" name="sipa" disabled>
