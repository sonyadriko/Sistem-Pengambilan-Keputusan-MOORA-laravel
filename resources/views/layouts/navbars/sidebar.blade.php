        ...
        <div class="collapse navbar-collapse" id="sidenav-collapse-main">
            ...
            <ul class="navbar-nav">
                ...
                @if (auth()->user()->type_user == 1)
                    ...
                    <li class="nav-item">
                        <a class="nav-link" href="{{ URL::to('/') }}/kriteria">
                    ...
                    <li class="nav-item">
                        <a class="nav-link" href="{{ URL::to('/') }}/history">
                            <i class="ni ni-watch-time text-info"></i> {{ __('History') }}
                        </a>
                    </li>

                    <!-- <li class="nav-item">
                    <a class="nav-link" href="{{ URL::to('/') }}/topik">
                        <i class="ni ni-collection text-warning"></i> {{ __('Topik') }}
                    </a>
                </li>
                <li class="nav-item">
                    <a class="nav-link" href="{{ URL::to('/') }}/tugas">
                        <i class="ni ni-laptop text-danger"></i> {{ __('Tugas') }}
                    </a>
                </li> -->
                    <li class="nav-item">
                ...
                @elseif(auth()->user()->type_user == 2)
                    ...
                    <!-- <li class="nav-item">
                    <a class="nav-link" href="{{ URL::to('/') }}/rekomendasi">
                        <i class="ni ni-key-25 text-info"></i> {{ __('Rekomendasi karyawan') }}
                    </a>
                </li> -->
                @endif
                <!-- <li class="nav-item">
