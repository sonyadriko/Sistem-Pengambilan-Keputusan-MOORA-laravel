                        ...
                        <div class="col-12 col-md-12 col-lg-12">
                            <div class="card">
                                ...
                                @foreach($karyawan as $row)
                                    <form action="{{URL::to('/')}}/karyawan/{{$row->id}}" method="POST" class="needs-validation" novalidate="" enctype="multipart/form-data">
                                    @csrf
                                    @method('PUT')
                                    <div class="tab-content">
                                        <div id="tabs-text-1" class="tab-pane fade show active">
                                            <div class="form-group">
                                                ...
                                                <input type="text" name="id_karyawan" class="form-control" value="{{$row->id_karyawan}}">
                                            </div>
                                            <div class="form-group">
